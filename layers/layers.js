...
lyr_HufigsterEnergietrger_2.set('fieldAliases', { 'gitter_id_100m': 'gitter_id_100m', 'x_mp_100m': 'x_mp_100m', 'y_mp_100m': 'y_mp_100m', 'insgesamt_energietraeger': 'insgesamt_energietraeger', 'Gas': 'Gas', 'Heizöl': 'Heizöl', 'holz_holzpellets': 'holz_holzpellets', 'biomasse_biogas': 'biomasse_biogas', 'solar_geothermie_waermepumpen': 'solar_geothermie_waermepumpen', 'strom': 'strom', 'kohle': 'kohle', 'fernwaerme': 'fernwaerme', 'kein_energietraeger': 'kein_energietraeger', 'dominierender_energieträger': 'dominierender_energieträger', });
lyr_HufigsteHeizungsart_3.set('fieldAliases', { 'gitter_id_100m': 'gitter_id_100m', 'x_mp_100m': 'x_mp_100m', 'y_mp_100m': 'y_mp_100m', 'insgesamt_heizungsart': 'insgesamt_heizungsart', 'fernheizung': 'fernheizung', 'Etagenheizung': 'Etagenheizung', 'blockheizung': 'blockheizung', 'Zentralheizung': 'Zentralheizung', 'Einzel-/Mehrraumofen': 'Einzel-/Mehrraumofen', 'keine_heizung': 'keine_heizung', 'dominierende_heizungsart': 'dominierende_heizungsart', });
...
lyr_HufigsterEnergietrger_2.set('fieldImages', { 'gitter_id_100m': 'TextEdit', 'x_mp_100m': 'Range', 'y_mp_100m': 'Range', 'insgesamt_energietraeger': 'Range', 'Gas': 'TextEdit', 'Heizöl': 'TextEdit', 'holz_holzpellets': 'TextEdit', 'biomasse_biogas': 'TextEdit', 'solar_geothermie_waermepumpen': 'TextEdit', 'strom': 'TextEdit', 'kohle': 'TextEdit', 'fernwaerme': 'TextEdit', 'kein_energietraeger': 'TextEdit', 'dominierender_energieträger': 'TextEdit', });
lyr_HufigsteHeizungsart_3.set('fieldImages', { 'gitter_id_100m': 'TextEdit', 'x_mp_100m': 'Range', 'y_mp_100m': 'Range', 'insgesamt_heizungsart': 'Range', 'fernheizung': 'TextEdit', 'Etagenheizung': 'TextEdit', 'blockheizung': 'TextEdit', 'Zentralheizung': 'TextEdit', 'Einzel-/Mehrraumofen': 'TextEdit', 'keine_heizung': 'TextEdit', 'dominierende_heizungsart': 'TextEdit', });
...
lyr_HufigsterEnergietrger_2.set('fieldLabels', { 'gitter_id_100m': 'no label', 'x_mp_100m': 'no label', 'y_mp_100m': 'no label', 'insgesamt_energietraeger': 'no label', 'Gas': 'no label', 'Heizöl': 'no label', 'holz_holzpellets': 'no label', 'biomasse_biogas': 'no label', 'solar_geothermie_waermepumpen': 'no label', 'strom': 'no label', 'kohle': 'no label', 'fernwaerme': 'no label', 'kein_energietraeger': 'no label', 'dominierender_energieträger': 'no label', });
lyr_HufigsteHeizungsart_3.set('fieldLabels', { 'gitter_id_100m': 'no label', 'x_mp_100m': 'no label', 'y_mp_100m': 'no label', 'insgesamt_heizungsart': 'no label', 'fernheizung': 'no label', 'Etagenheizung': 'no label', 'blockheizung': 'no label', 'Zentralheizung': 'no label', 'Einzel-/Mehrraumofen': 'no label', 'keine_heizung': 'no label', 'dominierende_heizungsart': 'no label', });
