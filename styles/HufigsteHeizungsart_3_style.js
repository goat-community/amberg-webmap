...
var style_HufigsteHeizungsart_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("dominierende_heizungsart");
    var labelText = "";
    size = 0;
...
var style = categories_HufigsteHeizungsart_3(feature, value, size, resolution, labelText,
